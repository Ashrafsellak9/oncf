...
def create_ref_systemes_table():
    try:
        ...
        # Créer la table ref_systemes
        cursor.execute("""
            DROP TABLE IF EXISTS gpr.ref_systemes CASCADE;
        """)
        ...
        print("✅ Table gpr.ref_systemes créée")
        ...
        print(f"📊 Structure du fichier ref_systemes.csv: {df.shape[0]} lignes, {df.shape[1]} colonnes")
        ...
        for index, row in df.iterrows():
            try:
                ...
                if success_count % 10 == 0:
                    print(f"📥 Importé {success_count} systèmes...")
        ...
        print(f"\n✅ Import terminé: {count} systèmes importés avec succès")
