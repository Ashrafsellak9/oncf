#!/usr/bin/env python3
"""
Script pour supprimer et recréer toutes les tables avec la vraie structure
"""
...
def recreate_tables_with_real_structure():
    """Supprimer et recréer toutes les tables avec la vraie structure"""
    
    try:
        print("🔧 Suppression et recréation des tables avec la vraie structure")
        print("=" * 80)
        ...
        cursor.execute("""
            CREATE TABLE gpr.ref_systemes (
                ...
                date_maj TIMESTAMP,
                intitule VARCHAR(255) NOT NULL,
                entite_id INTEGER REFERENCES gpr.ref_entites(id),
                etat VARCHAR(50),
        ...
        cursor.execute("""
            CREATE TABLE gpr.ref_types (
                ...
                date_maj TIMESTAMP,
                intitule VARCHAR(255) NOT NULL,
                system_id INTEGER REFERENCES gpr.ref_systemes(id),
                entite_type_id INTEGER REFERENCES gpr.ref_entites(id),
                etat VARCHAR(50),
                deleted BOOLEAN DEFAULT FALSE
            )
        """)
        ...
        cursor.execute("""
            CREATE TABLE gpr.ref_sous_types (
                ...
                date_maj TIMESTAMP,
                etat VARCHAR(50),
                type_id INTEGER REFERENCES gpr.ref_types(id),
                entitest_id INTEGER REFERENCES gpr.ref_entites(id),
                intitule VARCHAR(255) NOT NULL,
                deleted BOOLEAN DEFAULT FALSE
            )
        """)
        ...
        cursor.execute("""
            CREATE TABLE gpr.ref_sources (
                ...
                etat VARCHAR(50),
                intitule VARCHAR(255) NOT NULL,
                entite_source_id INTEGER REFERENCES gpr.ref_entites(id),
                deleted BOOLEAN DEFAULT FALSE
            )
        """)
        ...
        cursor.execute("""
            CREATE TABLE gpr.ge_localisation (
                ...
                site_surete_id INTEGER REFERENCES gpr.ref_site_surete(id),
                wilaya_id INTEGER,
        ...
        # 9. Créer la table ge_evenement avec la vraie structure
        ...
        cursor.execute("""
            CREATE TABLE gpr.ge_evenement (
                ...
                user_id INTEGER,
                source_id INTEGER REFERENCES gpr.ref_sources(id),
                sous_type_id INTEGER REFERENCES gpr.ref_sous_types(id),
                system_id INTEGER REFERENCES gpr.ref_systemes(id),
                type_id INTEGER REFERENCES gpr.ref_types(id),
                extrait TEXT,
                ...
                localisation_id INTEGER REFERENCES gpr.ge_localisation(id)
            )
        """)
...
if __name__ == "__main__":
    recreate_tables_with_real_structure()
